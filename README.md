...
4. ¡Haz clic en **Deploy**! Vercel construirá automáticamente el frontend en React y desplegará la API de Express como Serverless Functions.
...
2. Configura la URL de tu base de datos como variable de entorno (por ejemplo, en tu terminal o en un archivo `.env` para la API):
```bash
